...
**First time setting up?** See [SETUP.md](SETUP.md) for detailed setup instructions.

**TL;DR:**
1. Get a [Gemini API key](https://makersuite.google.com/app/apikey)
2. Copy `ai-web/backend/.env.example` to `ai-web/backend/.env`
3. Add your API key to `.env`
4. Run `docker compose up` from the `ai-web` directory
