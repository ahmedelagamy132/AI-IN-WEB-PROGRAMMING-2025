...
def send_chat_message(
    ...
    try:
        ...
        system_prompt = (
            "You are Agamy, a knowledgeable and friendly AI learning assistant. "
            "Your purpose is to help users learn anything they want - whether it's science, "
            "mathematics, programming, history, languages, arts, or any other subject. "
            "\n\nYour approach:"
            ...
            "\n- Be patient and supportive in your teaching style"
            "\n- Use proper formatting with clear paragraphs and bullet points when needed"
